    ...
    <div className="bg-slate-950 border border-slate-800 rounded-xl shadow-lg mb-6 overflow-hidden">
      ...
      <div className={`px-4 py-3.5 flex flex-wrap items-center justify-between gap-3 border-b ${
        ...
        <div className="flex items-center gap-2.5">
          <Database className={`h-5 w-5 ${config.isMock ? 'text-amber-400' : 'text-emerald-400'}`} />
          <div>
            ...
            <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-mono font-black uppercase ${
              config.isMock 
                ...
                : 'bg-emerald-955/40 text-emerald-300 border border-emerald-800/20'
            }`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mb-4 leading-relaxed">
                ...
                <span className="bg-slate-950 px-1 py-0.5 rounded font-mono break-all font-semibold text-emerald-400 text-[10px]"> Settings &gt; API</span>. 
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs px-3 py-2.5 border border-slate-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-950 text-slate-100"
                  />
                </div>
                ...
                <div className="flex gap-2.5 pt-2">
                  <button
                    type="submit"
                    className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-black uppercase tracking-wider text-xs rounded-lg py-2.5 px-4 shadow-lg shadow-emerald-900/20 transition-colors cursor-pointer"
                  >
                    Guardar y Conectar
                  </button>
              ...
              <div className="mt-6 p-4 bg-slate-950 rounded-lg border border-slate-800">
                ...
                <ul className="text-xs text-slate-400 space-y-1.5 list-disc pl-4 leading-normal font-mono">
                  <li>Inicia sesión en tu cuenta de <a href="https://supabase.com" target="_blank" rel="noreferrer" className="text-emerald-400 font-bold hover:underline inline-flex items-center gap-0.5">Supabase <ExternalLink className="h-3 w-3" /></a>.</li>
                  ...
                  <li>Nómbralo exactamente <strong className="bg-slate-900 px-1 rounded font-mono text-[11px] text-emerald-400">jugadores</strong>.</li>
            ...
            <div className="flex flex-col">
              <div className="flex justify-between items-center mb-2.5">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-400 bg-slate-950 border border-slate-800 hover:bg-slate-900 rounded-lg px-2 py-1 transition-colors cursor-pointer"
                >
                  {copied ? (
                    <>
              ...
              <p className="text-xs text-slate-400 mb-3 leading-relaxed">
                Copia este script SQL y pégalo en el panel de <strong>SQL Editor &gt; New Query</strong> de Supabase para crear la tabla <code className="font-semibold text-xs font-mono bg-slate-950 px-1 py-0.5 rounded text-emerald-400">jugadores</code> con sus políticas de seguridad (RLS).
              </p>
